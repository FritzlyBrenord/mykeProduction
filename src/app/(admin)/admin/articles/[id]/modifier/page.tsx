...
import { useArticle, useUpdateArticle } from '@/hooks/useAdmin';
...
export default function ModifierArticlePage({ params: paramsPromise }: { params: Promise<{ id: string }> }) {
  ...
  // Generate slug dynamically only if not modified manually yet
  React.useEffect(() => {
    if (title && !isDirty) {
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 border-b border-[var(--border)] pb-6">
        ...
        <div>
          ...
          <p className="text-[var(--muted)] mt-1">Éditez les informations de cet article</p>
        </div>
      </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-[var(--card)] p-5 rounded-xl border border-[var(--border)] space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-[var(--foreground)]">Lien (Slug) <span className="text-red-500">*</span></label>
                <Input
                  {...register('slug')}
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-[var(--foreground)]">Catégories <span className="text-red-500">*</span></label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-[var(--foreground)]">URL Miniature (Image)</label>
                <Input
