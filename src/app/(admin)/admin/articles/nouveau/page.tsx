...
import { useCreateArticle, useUpload } from "@/hooks/useAdmin";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h1 className="text-3xl font-bold text-[var(--foreground)]">Nouvel article</h1>
          <p className="text-[var(--muted)] mt-1">Creez un nouvel article pour votre blog</p>
        </div>
      </motion.div>
            ...
            <div className="bg-[var(--card)] p-5 rounded-xl border border-[var(--border)] space-y-5">
              ...
              <div className="space-y-2">
                ...
                {uploadMutation.isPending && (
                  <p className="text-xs text-[var(--muted)]">Upload en cours...</p>
                )}
                {thumbnailUrl && !uploadMutation.isPending && (
                  <p className="text-xs text-[var(--muted)]">
                    Image chargee. Cliquez sur "Sauvegarder l'article" pour enregistrer.
                  </p>
                )}
              </div>
